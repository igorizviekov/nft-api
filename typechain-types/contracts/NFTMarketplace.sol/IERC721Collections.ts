...
export interface IERC721CollectionsInterface extends utils.Interface {
  functions: {
...
export interface IERC721Collections extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721CollectionsInterface;
